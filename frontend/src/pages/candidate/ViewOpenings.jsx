                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-blue-600 dark:group-hover:text-zinc-300 transition-colors">
                          {job.title}
                        ...
                        <div className="flex flex-wrap items-center gap-3 mt-2 text-sm font-medium text-zinc-500 dark:text-zinc-400">
                    ...
                    <div className="flex items-center gap-4 w-full md:w-auto mt-2 md:mt-0">
                      <div className="text-right hidden md:block">
                        ...
                        <p className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mt-0.5">Salary Range</p>
                      </div>
                      {appliedApp ? (
                        <button
                          disabled
