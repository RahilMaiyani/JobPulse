        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {statCards.map((stat, i) => (
              <div key={i} className="relative overflow-hidden bg-white dark:bg-zinc-900 p-6 rounded-2xl border border-zinc-200 dark:border-zinc-700 shadow-sm group hover:border-zinc-300 dark:hover:border-zinc-600 hover:shadow-md transition-all duration-350">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-700 rounded-2xl p-6 shadow-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-3">
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-700 rounded-[2rem] p-6 sm:p-8 shadow-sm">
                ...
                <div className="space-y-3">
                  {stats.recentJobs.length > 0 ? (
                    stats.recentJobs.map((job) => (
                      <Link to={`/admin/jobs`} key={job.id} className="flex items-center justify-between p-4 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/50 dark:border-zinc-700/50 rounded-2xl hover:border-zinc-300 dark:hover:border-zinc-600 transition-all group shadow-sm">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-700 rounded-[2rem] p-6 sm:p-8 shadow-sm h-full flex flex-col">
                <div className="mb-6">
                ...
                <div className="flex-1 space-y-4">
                  {stats.recentActivities && stats.recentActivities.length > 0 ? (
                    stats.recentActivities.map((act, i) => (
                      <div key={i} className="p-4 bg-zinc-50 dark:bg-zinc-800/50 border border-zinc-200/50 dark:border-zinc-700/50 rounded-2xl flex items-start gap-4 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors">
