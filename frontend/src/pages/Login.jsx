...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-100 dark:from-zinc-950 via-white dark:via-zinc-900 to-slate-50 dark:to-zinc-950 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-2xl border border-white/20 dark:border-zinc-800 rounded-3xl shadow-2xl shadow-slate-200/50 dark:shadow-none p-10">
          ...
          <div className="flex flex-col items-center gap-4 mb-10 justify-center">
            <div className="p-3 bg-slate-900 dark:bg-zinc-800 rounded-2xl shadow-lg shadow-slate-900/20 dark:shadow-none">
              <Briefcase className="text-white dark:text-zinc-100 w-7 h-7" />
            </div>
            <div className="text-center">
              <h1 className="text-2xl font-black text-slate-900 dark:text-zinc-100 tracking-tight">Welcome Back</h1>
              <p className="text-slate-500 dark:text-zinc-400 text-sm mt-1.5 font-medium">Sign in to the internal portal</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="pt-6 text-center text-sm font-medium text-slate-500 dark:text-zinc-400">
              ...
              <Link to="/register" className="text-slate-900 dark:text-zinc-100 font-bold hover:underline">
                Register here
              </Link>
            </div>
