...
export default function ManageQuizSkeleton() {
  return (
    <div className="space-y-6 animate-pulse">
      ...
      <div className="bg-slate-50 dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-2xl p-6">
        <div className="w-40 h-6 bg-slate-200 dark:bg-zinc-800 rounded mb-4"></div>
      ...
      <div className="space-y-4">
        {[1, 2].map(n => (
          <div key={n} className="border border-slate-200 dark:border-zinc-800 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[1, 2, 3, 4].map(o => (
                <div key={o} className="w-full h-10 bg-slate-200 dark:bg-zinc-800 rounded-xl"></div>
              ))}
            </div>
          </div>
        ))}
