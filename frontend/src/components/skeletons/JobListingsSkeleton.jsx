    ...
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Array.from({ length: count }).map((_, n) => (
          <div key={n} className="bg-white dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-3xl p-6 space-y-5 animate-pulse flex flex-col justify-between h-[280px]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-2 flex-1">
                  ...
                  <div className="flex gap-2">
                    ...
                    <div className="h-4 bg-slate-200 dark:bg-zinc-800 rounded w-20"></div>
                  </div>
                </div>
              </div>
              <div className="space-y-3 pt-2">
                <div className="flex items-center gap-2">
                  <div className="w-4 h-4 rounded bg-slate-200 dark:bg-zinc-800"></div>
            ...
            <div className="border-t border-slate-100 dark:border-zinc-800/80 pt-4">
              <div className="h-9 bg-slate-200 dark:bg-zinc-800 rounded-xl w-full"></div>
            </div>
          </div>
        ))}
      </div>
          ...
          {Array.from({ length: count }).map((_, n) => (
            <tr key={n} className="animate-pulse">
              <td className="px-6 py-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-lg bg-slate-200 dark:bg-zinc-800 shrink-0"></div>
                  <div className="space-y-1">
                    <div className="h-6 w-32 bg-slate-200 dark:bg-zinc-800 rounded"></div>
                    <div className="h-4 w-24 bg-slate-200 dark:bg-zinc-800 rounded"></div>
                  </div>
                </div>
              </td>
              <td className="px-6 py-4 hidden md:table-cell"><div className="h-4 w-20 bg-slate-200 dark:bg-zinc-800 rounded"></div></td>
              <td className="px-6 py-4"><div className="h-6 w-16 bg-slate-200 dark:bg-zinc-800 rounded-md"></div></td>
              <td className="px-6 py-4 hidden sm:table-cell"><div className="h-4 w-24 bg-slate-200 dark:bg-zinc-800 rounded"></div></td>
              <td className="px-6 py-4 text-right"><div className="h-9 w-9 bg-slate-200 dark:bg-zinc-800 rounded-lg ml-auto"></div></td>
            </tr>
          ))}
        </tbody>
      </table>
