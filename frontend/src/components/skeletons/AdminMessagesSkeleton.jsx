          ...
          <div key={i} className="p-5 animate-pulse flex items-start justify-between gap-4">
            <div className="flex-1 space-y-3">
              ...
              <div className="flex items-center gap-2 pl-5">
                ...
                <div className="h-3 w-4 bg-slate-200 dark:bg-zinc-800 rounded"></div>
                <div className="h-3 w-24 bg-slate-200 dark:bg-zinc-800 rounded"></div>
              </div>
              <div className="space-y-2 pl-5">
                <div className="h-4 w-full max-w-2xl bg-slate-100 dark:bg-zinc-800/50 rounded"></div>
                <div className="h-4 w-3/4 max-w-lg bg-slate-100 dark:bg-zinc-800/50 rounded"></div>
              </div>
            </div>
            <div className="flex items-center gap-2">
               <div className="w-8 h-8 rounded-xl bg-slate-200 dark:bg-zinc-800"></div>
               <div className="w-8 h-8 rounded-xl bg-slate-200 dark:bg-zinc-800"></div>
            </div>
          </div>
        ))}
