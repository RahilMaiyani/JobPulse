          ...
          <tbody className="divide-y divide-slate-100">
            {Array.from({ length: count }).map((_, n) => (
              <tr key={n} className="animate-pulse">
                ...
                <td className="px-6 py-4"><div className="h-6 w-20 bg-slate-200 dark:bg-zinc-800 rounded-md"></div></td>
                <td className="px-6 py-4"><div className="h-4 w-16 bg-slate-200 dark:bg-zinc-800 rounded"></div></td>
                <td className="px-6 py-4 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <div className="h-9 w-24 bg-slate-200 dark:bg-zinc-800 rounded-lg"></div>
                    <div className="h-9 w-24 bg-slate-200 dark:bg-zinc-800 rounded-lg"></div>
                  </div>
                </td>
              </tr>
