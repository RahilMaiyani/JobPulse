...
export default function OfflineBanner() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[9999] animate-in slide-in-from-bottom-10 duration-300">
      <div className="bg-zinc-900 border border-zinc-700 text-white px-5 py-4 rounded-2xl shadow-2xl flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-[11px] font-medium text-zinc-400 uppercase tracking-widest mt-0.5">
            Offline Mode Active
          </p>
        </div>
      </div>
